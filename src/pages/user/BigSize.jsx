                    ...
                    <div className="row">
                            ...
                            <div className="product demo21">
                                <figure className="product-media">
                                    ...
                                    <Link className="d-flex justify-content-center" to="/orangeoriginal">
                                        <img
                                            src="../../../public/assets/images/big/orange.png"
                                            alt="Product image"
                                        />
                                    </Link>
                                </figure>
                        ...
                        <div className="col-md-3">
                            <div className="product demo21">
                                <figure className="product-media">
                                    <span className="product-label label-new">New</span>
                                    <Link className="d-flex justify-content-center" to="/matchaoriginal">
                                        <img
                                            src="../../../public/assets/images/big/matcha.png"
                                            alt="Product image"
                                        />
                                    </Link>
                                </figure>
                                <div className="product-body text-center">
                                    ...
                                    <h3 className="product-title">
                                        <Link to="/matchaoriginal">Matcha Big Size 150mL</Link>
                                    </h3>
                                    <div className="product-price">
                                        <span className="cur-price">Rp195.000</span>
                                    </div>
                            ...
                            <div className="product demo21">
                                <figure className="product-media">
                                    ...
                                    <Link className="d-flex justify-content-center" to="/blackoriginal">
                                        <img
                                            src="../../../public/assets/images/big/black.png"
                                            alt="Product image"
                                        />
                                    </Link>
                                </figure>
                        ...
                        <div className="col-md-3">
                            <div className="product demo21">
                                <figure className="product-media">
                                    <span className="product-label label-new">New</span>
                                    <Link className="d-flex justify-content-center" to="/purehoneyoriginal">
                                        <img
                                            src="../../../public/assets/images/big/pure.png"
                                            alt="Product image"
                                        />
                                    </Link>
                                </figure>
                                <div className="product-body text-center">
                                    ...
                                    <h3 className="product-title">
                                        <Link to="/purehoneyoriginal">Pure Honey Big Size 150mL</Link>
                                    </h3>
                                    <div className="product-price">
                                        <span className="cur-price">Rp195.000</span>
                                    </div>
                            ...
                            <div className="product demo21">
                                <figure className="product-media">
                                    ...
                                    <Link className="d-flex justify-content-center" to="/whiteoriginal">
                                        <img
                                            src="../../../public/assets/images/big/white.png"
                                            alt="Product image"
                                        />
                                    </Link>
                                </figure>
                            ...
                            <div className="product demo21">
                                <figure className="product-media">
                                    ...
                                    <Link className="d-flex justify-content-center" to="/yuzuoriginal">
                                        <img
                                            src="../../../public/assets/images/big/yuzu.png"
                                            alt="Product image"
                                        />
                                    </Link>
                                </figure>
